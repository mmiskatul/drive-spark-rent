...
export default function CustomerBookingDetails({ id }: { id?: string }) {
  ...
  return (
    <DashboardLayout role="customer">
      <Button asChild variant="ghost" size="sm" className="mb-4 -ml-3"><Link href="/customer/bookings"><ArrowLeft className="h-4 w-4 mr-1" /> Back</Link></Button>
