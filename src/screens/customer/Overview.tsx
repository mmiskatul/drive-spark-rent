  ...
  return (
    <DashboardLayout role="customer">
      <PageHeader
        ...
        actions={<Button asChild className="rounded-full"><Link href="/cars">Find a car</Link></Button>}
      />
      ...
      <div className="mt-6 grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 rounded-2xl border border-border bg-card">
          <div className="flex items-center justify-between p-5 border-b border-border">
            ...
            <Button asChild variant="ghost" size="sm"><Link href="/customer/bookings">All bookings <ArrowRight className="ml-1 h-3.5 w-3.5" /></Link></Button>
          </div>
