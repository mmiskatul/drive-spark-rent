    ...
    <>
      ...
      <section className="container py-24 text-center">
        ...
        <div className="mt-8 flex justify-center gap-3 flex-wrap">
          <Button asChild size="lg" className="rounded-full"><Link href="/cars">Find your car</Link></Button>
          <Button asChild size="lg" variant="outline" className="rounded-full"><Link href="/register">Become a partner</Link></Button>
        </div>
      </section>
    </>
  );
