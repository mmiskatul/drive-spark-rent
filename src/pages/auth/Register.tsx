    ...
    <AuthLayout title="Create your account" subtitle="Join the most premium car rental marketplace">
      <Tabs defaultValue="customer">
        ...
        <TabsContent value="customer">
          <form onSubmit={(e) => { e.preventDefault(); toast.success("Account created"); nav("/customer"); }} className="space-y-4">
            ...
            <p className="text-center text-sm text-muted-foreground">Already have an account? <Link to="/login" className="text-primary font-semibold hover:underline">Sign in</Link></p>
          </form>
        </TabsContent>

        <TabsContent value="partner">
          <form onSubmit={(e) => { e.preventDefault(); toast.success("Partner application submitted", { description: "Verification typically takes 24–48h." }); nav("/partner"); }} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
