    ...
    <>
            ...
            <div className="animate-fade-in">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button asChild size="lg" className="rounded-full bg-white text-primary hover:bg-white/90 shadow-glow">
                  <Link to="/cars">Browse cars <ArrowRight className="ml-1 h-4 w-4" /></Link>
                </Button>
            ...
            <div className="rounded-2xl bg-card border border-border shadow-elegant p-2 sm:p-3 max-w-5xl mx-auto">
              <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-1">
                ...
                <Button asChild size="lg" className="lg:h-auto rounded-xl shadow-soft">
                  <Link to="/cars"><Search className="mr-2 h-4 w-4" /> Search</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <section className="container py-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {locations.map((loc) => (
            <Link key={loc.name} to="/cars" className="group relative aspect-[4/5] overflow-hidden rounded-2xl border border-border">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <Button asChild variant="outline" className="mt-6 rounded-full">
              <Link to="/faq">See all FAQs <ArrowRight className="ml-1 h-4 w-4" /></Link>
            </Button>
          </div>
