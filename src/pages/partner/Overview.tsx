  ...
  return (
    <DashboardLayout role="partner">
      <PageHeader
        ...
        actions={<Button asChild className="rounded-full"><Link to="/partner/cars/new"><Plus className="h-4 w-4 mr-1" /> Add car</Link></Button>}
      />
      ...
      <div className="mt-6 grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 rounded-2xl border border-border bg-card">
          <div className="flex items-center justify-between p-5 border-b border-border">
            ...
            <Button asChild variant="ghost" size="sm"><Link to="/partner/requests">View all <ArrowRight className="ml-1 h-3.5 w-3.5" /></Link></Button>
          </div>
